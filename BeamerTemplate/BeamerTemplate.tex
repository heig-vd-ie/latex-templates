...
%confidentiality flag: set to true or false
\newif\ifconfidential
\confidentialfalse   % set to \confidentialfalse or \confidentialtrue

% Corner logos (replace file names; or set \showcornerlogosfalse)
\newif\ifshowcornerlogos
\showcornerlogostrue 
\newcommand{\LogoTopRight}{\includegraphics[height=0.95cm]{IE_HEIG-VD_logotype_rouge_rvb}}
\newcommand{\LogoBottomLeft}{\includegraphics[height=2cm]{HES_SO_Logo_RGB}}

% ======================================================================
%  THEME: all white, hairlines only, one (or two) accent color
% ======================================================================
...
% ------ Corner logos and stamp (background canvas) --------------------
